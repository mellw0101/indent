...
usage(void)
{
    ...
    print_opt("-version", "--version", "");
    print_opt("-v", "--verbose", "");
    print_opt("-h", "--usage", "");
    print_opt("-ut", "--use-tabs", "");
    print_opt("-ts", "--tab-size", "");
    print_opt("-sob", "--swallow-optional-blank-lines", "");
    print_opt("-sbi", "--struct-brace-indentation", "");
    print_opt("-sc", "--start-left-side-of-comments", "");
    print_opt("-st", "--standard-output", "");
    print_opt("-ss", "--space-special-semicolon", "");
    print_opt("-saw", "--space-after-while", "");
    print_opt("-pcs", "--space-after-procedure-calls", "");
    print_opt("-prs", "--space-after-parentheses", "");
    print_opt("-sai", "--space-after-if", "");
    print_opt("-saf", "--space-after-for", "");
    print_opt("-cs", "--space-after-cast", "");
    print_opt("-nlps", "--remove-preprocessor-space", "");
    print_opt("-psl", "--procnames-start-lines", "");
